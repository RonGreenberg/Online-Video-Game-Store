...
mongoimport --db online-video-game-store --collection games --file games.json --jsonArray --mode=upsert
mongoimport --db online-video-game-store --collection orders --file orders.json --jsonArray --mode=upsert
